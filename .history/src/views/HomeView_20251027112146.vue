...
const trendingRepos = ref<Trending[]>([
  {
    id: 1,
      ...
      <div class="grid">
        ...
        >
          ...
          <div class="repo-meta">
            ...
            <div class="stars">
              <svg class="star" fill="currentColor" viewBox="0 0 16 16">
                <path
...
@keyframes moveBall {
  ...
  50% { transform: translate(400px, 200px) scale(1); }
  75% { transform: translate(200px, 300px) scale(0.8); }
...
.search-box { display: flex; justify-content: center; gap: 0.75rem; max-width: 600px; margin: 0 auto; }
...
.view-all {
  color: #a78bfa; font-size: 0.9rem; text-decoration: none;
  display: flex; align-items: center; gap: 0.25rem; transition: all 0.2s;
}
...
.card { padding: 2rem 1.75rem; border-radius: 12px; text-align: center; transition: all 0.3s ease; }
...
.card h3 { font-size: 1.25rem; font-weight: 600; margin: 1rem 0 0.75rem; color: var(--text); }
...
.repo-name { color: var(--link); font-weight: 600; font-size: 1.1rem; margin: 0 0 0.75rem 0; transition: color 0.2s; }
.repo-card:hover .repo-name { opacity: 0.8; }
.repo-desc { color: var(--muted); font-size: 0.9rem; margin-bottom: 1.25rem; line-height: 1.5; flex: 1; min-height: 3rem; }
.repo-meta { display: flex; justify-content: space-between; align-items: center; font-size: 0.875rem; color: var(--muted); margin-top: auto; }
