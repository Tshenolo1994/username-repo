  ...
  <div class="home-page">
    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <p class="hero-sub">
            Enter a GitHub <strong>username</strong> to browse public repositories, inspect commits,
  view file-level diffs, and save favourite commits for quick access.
        </p>
