...
<template>
  <header class="header">
    <div class="header-content">
      ...
      <!-- Header search (reuses the global SearchBar component) -->
...
@media (max-width: 900px) {
  ...
  .github-link { display: none; }  /* keep header compact on smaller screens */
}

@media (max-width: 640px) {
  .header-content {
    grid-template-columns: 1fr auto; /* brand | actions */
    grid-template-rows: auto auto;    /* search on its own row */
  }
  .header-search {
    grid-column: 1 / -1;
    width: 100%;
